...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("EarthDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.earthdetector.com"];
pub const RS_PUB_KEY: &str = "GLpweyZGztitcbfX05TATyVR0LfEvuxl2IDBHIiamcA=";
